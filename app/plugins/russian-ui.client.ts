...
const REPLACEMENTS: [string, string][] = [
  ...
  ['Continue with SSO', 'Продолжить через SSO'],
  ...
  ['Add job', 'Добавить вакансию'],
  ['No candidates yet', 'Кандидатов пока нет'],
  ['No applications yet', 'Откликов пока нет'],
  ['Open Positions', 'Открытые вакансии'],
  ['Organization', 'Организация'],
  ['Create Organization', 'Создать организацию'],
  ['Pick an organization', 'Выберите организацию'],
  ['Join organization', 'Присоединиться к организации'],
  ['Your recruiting command center', 'Центр управления подбором'],
  ['Recent applications', 'Недавние отклики'],
  ['Upcoming interviews', 'Предстоящие собеседования'],
  ['Quick actions', 'Быстрые действия'],
  ['Pipeline overview', 'Обзор воронки'],
  ['Draft', 'Черновик'],
  ...
  ['Schedule interview', 'Запланировать собеседование'],
  ['All jobs', 'Все вакансии'],
  ['All candidates', 'Все кандидаты'],
  ['All applications', 'Все отклики'],
  ['Status', 'Статус'],
  ['Location', 'Локация'],
  ['Type', 'Тип'],
  ['Created', 'Создано'],
  ['Updated', 'Обновлено'],
  ['Name', 'Имя'],
  ['Open-source ATS', 'Открытая система подбора'],
  ['applicant tracking', 'подбор кандидатов'],
  ['Open Positions — Job Board', 'Открытые вакансии — доска вакансий'],
]
