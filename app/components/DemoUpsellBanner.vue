        ...
        <div class="relative p-4">
          ...
          <div class="mt-3.5 grid grid-cols-2 gap-2">
            ...
            >
              ...
              <span class="text-[12px] font-semibold text-white/70 transition-colors group-hover:text-white">{{ t('demoUpsell.cloud') }}</span>
            ...
            >
              ...
              <span class="text-[12px] font-semibold text-white/70 transition-colors group-hover:text-white">{{ t('demoUpsell.selfHost') }}</span>
              <ArrowRight class="ml-auto size-3 text-white/20 opacity-0 transition-all group-hover:translate-x-0.5 group-hover:opacity-100" />
            </a>
          </div>
