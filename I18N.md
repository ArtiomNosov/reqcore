...
- Default locale: `ru` (thesis fork branch `thesis/ru-localization`)
- Enabled locales: `ru`, `en`, `es`, `fr`, `de`, `nb`, `vi`
...
- Russian locale (thesis fork): `i18n/locales/ru.json`
- Client overlay for remaining UI strings: `app/plugins/russian-ui.client.ts`
- Target locale files:
...
## Russian localization (thesis fork)

See **`RUNBOOK-RU.md`** for Docker, migrate, reseed, dev server, demo login, and screenshot verification (`npm run i18n:screenshots`).
